...
import com.dixitpatel.movieratingdemo.databinding.ItemFavoriteTvBinding
import com.dixitpatel.movieratingdemo.feature_movie_rating.domain.model.FavoriteTv

class FavoriteTvAdapter(private val onItemClicked: (item: FavoriteTv) -> Unit) : ListAdapter<FavoriteTv, FavoriteTvAdapter.ViewHolder>(
    DIFF_CALLBACK
) {
